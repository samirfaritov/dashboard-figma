...
var opisanie = document.querySelector(".opisanie");
...
var data = "";
var vremya = "";
zagolovok.addEventListener("keyup", function (e) {
  title = e.target.value;
});
opisanie.addEventListener("keyup", function (e) {
...
var neww = document.querySelector(".neww");
...
window.addEventListener("click", function (e) {
  ...
  var c = newDate.getFullYear();
  e.preventDefault();
  if (e.target.hasAttribute("data-action")) {
    var newTodo = {
      title: title,
      project: project,
      data: "".concat(a, ":").concat(b, ":").concat(c),
      vremya: "".concat(hours, ":").concat(minute)
    };
    if (title, project, data, vremya === "") {
      alert("hammasini to'ldir!!!");
    } else {
      var todoHtml = "\n          <div class=\"item\">\n          <p class=\"project\">".concat(newTodo.project, "</p>\n          <p class=\"title\">").concat(newTodo.title, "</p>\n          <div class=\"p3\">\n              <p class=\"data\">").concat(newTodo.data, "</p>\n              <p class=\"vremya\">").concat(newTodo.vremya, "</p>\n              <p class=\"start\">").concat(statuss, "</p>\n          </div>\n          </div>\n              ");
